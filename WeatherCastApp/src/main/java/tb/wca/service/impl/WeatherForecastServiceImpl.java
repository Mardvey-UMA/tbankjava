...
public class WeatherForecastServiceImpl implements WeatherForecastService {
    ...
    private final WeatherRequestBuilderService weatherRequestBuilderService;
    ...
    public List<WeatherModel> getWeatherForecastByDay(String city, String day) {
        RequestParams params = weatherRequestBuilderService.byDay(city, day);
    ...
    public List<WeatherModel> getWeatherForecastByDayAndHour(String city, String day, String hour) {
        ...
        RequestParams params = weatherRequestBuilderService.byDayHour(city, day, hour);
    ...
    public List<WeatherModel> getWeatherForecastByRange(String city, String start, String end) {
        ...
        RequestParams params = weatherRequestBuilderService.byRange(city, start, end);
